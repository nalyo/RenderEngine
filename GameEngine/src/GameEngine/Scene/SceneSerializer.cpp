...
namespace GameEngine{
	...
	{
		out << YAML::BeginMap;
		out << YAML::Key << "Entity" << YAML::Value << "12837156161321513215";
	...
	bool SceneSerializer::Deserialize(const std::string& filepath)
	{
		...
		if (entities)
		{
			for (auto entity : entities)
			{
				...
				{
					auto& spriterRenderer = deserializedEntity.AddComponent<SpriteRendererComponent>();
					spriterRenderer.Color = spriteRendererComponent["Color"].as<glm::vec4>();
				}
			}
		}
